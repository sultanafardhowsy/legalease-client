    ...
    <section className="px-6 pb-16">
      <div className="max-w-screen-xl mx-auto">
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl p-10 md:p-16 text-center border transition-colors duration-500
                     bg-slate-100 dark:bg-slate-900/50 
                     border-amber-500/20 shadow-2xl"
        >
          {/* Decorative orbs - Hidden or adjusted for light mode if needed */}
